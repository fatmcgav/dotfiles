# Generated by Powerlevel10k configuration wizard on 2019-11-07 at 17:02 EST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh.
# Wizard options: awesome-patched + powerline, small icons, rainbow, angled separators,
# sharp heads, flat tails, 2 lines, disconnected, left frame, dark, compact, many icons,
# concise.
...
() {
  ...
  ################################[ battery: internal battery ]#################################
  # Hide battery when fully charged
  typeset -g POWERLEVEL9K_BATTERY_HIDE_ABOVE_THRESHOLD=100
  typeset -g POWERLEVEL9K_BATTERY_LEVEL_BACKGROUND=(darkred orange4 yellow yellow chartreuse3 green3 green4 darkgreen)
